// hs-cloudinary.js — Cloudinary Upload Helper — Clean Preset

const CLOUD_NAME = 'dqmjfw1qb';
const UPLOAD_PRESET = 'hs_clean'; // Your new clean preset
...
console.log('[OG Shoots] Cloudinary ready with clean preset: hs_clean');